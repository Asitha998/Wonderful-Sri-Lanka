...
<html lang="en">
    ...
    <head>
        ...
        <style>
            ...
            .booking-form-container {
                width: 100%; /* Ensure the form container fills its column */
            }
            ...
            @media (min-width: 992px) {
                .col-lg-12 .row > div { /* Target direct children columns of the row inside col-lg-12 */
                    flex: 0 0 auto;
                    width: 50%; /* Make them take half width on large screens */
                }
            }
            ...
            #destination-images-panel {
                ...
                border-radius: 15px;
                box-shadow: 0 5px 20px rgba(0, 0, 0, 0.1);
                height: 100%; /* Fill height of its parent column */
                display: flex;
            ...
            @media (max-width: 991.98px) {
                #destination-images-panel {
                    ...
                    margin-bottom: 30px; /* Space between image panel and form */
                }
            }
        </style>
    </head>
                    ...
                    $destinations_data = [
                        ...
                        'anuradhapura' => [
                            ...
                            'gallery_images' => [
                                ...
                                'https://placehold.co/400x300/35682D/FFFFFF?text=Anuradhapura+3'
                            ]
                        ],
                        'polonnaruwa' => [
                            'name' => 'Polonnaruwa', 
            ...
            <div class="container py-5">
                <div class="row justify-content-center g-5">
                    ...
                    <div class="col-lg-5 col-md-10 mb-4 mb-lg-0">
                        <div id="destination-images-panel" class="px-4 py-1 rounded " style="background-color: var(--bs-light); box-shadow: 0 5px 20px rgba(0, 0, 0, 0.1);">
                    ...
                    <div class="col-lg-7 col-md-10">
                        <div class="booking-form-container">
                            <h1 class="text-center mb-4">Confirm Your Travel Booking</h1>
                            <form id="bookingForm">
                                <!-- A. Traveler Information -->
                                <h3 class="section-heading">1. Traveler Information</h3>
                                ...
                                <h3 class="section-heading">2. Select a Tour Guide (Optional)</h3>
                                <div class="row g-3 mb-4">
                                    <div class="col-12">
                                        <div class="selection-card d-flex align-items-center" data-service-type="guide" data-value="none">
                                    ...
                                    <div class="col-md-6">
                                        <div class="selection-card d-flex align-items-center" data-service-type="guide" data-value="guide1">
                                            ...
                                            <label class="form-check-label w-100" for="guide1">
                                                ...
                                                <small class="text-muted">Languages: English, Sinhala | 5+ Years Experience</small>
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="selection-card d-flex align-items-center" data-service-type="guide" data-value="guide2">
                                            ...
                                            <label class="form-check-label w-100" for="guide2">
                                                ...
                                                <small class="text-muted">Languages: English, Tamil, German | Specializes in Culture</small>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <h3 class="section-heading">3. Select Nearby Accommodation (Optional)</h3>
                                <div class="row g-3 mb-4">
                                    <div class="col-12">
                                        <div class="selection-card d-flex align-items-center" data-service-type="accommodation" data-value="none">
                                    ...
                                    <div class="col-md-6">
                                        <div class="selection-card d-flex align-items-center" data-service-type="accommodation" data-value="hotel1">
                                            ...
                                            <label class="form-check-label w-100" for="hotel1">
                                                ...
                                                <small class="text-muted">Rating: 4.5/5 | 2km from center</small>
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="selection-card d-flex align-items-center" data-service-type="accommodation" data-value="hotel2">
                                            ...
                                            <label class="form-check-label w-100" for="hotel2">
                                                ...
                                                <small class="text-muted">Rating: 4.0/5 | 1.5km from center</small>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <!-- Accommodation Details Display -->
                                <div class="col-12" id="accommodation-details-display">
                                    <h4>Selected Accommodation Details</h4>
                                    <div class="row g-4">
                                        <div class="col-lg-6">
                                            <img id="acc-detail-img" src="" class="img-fluid rounded mb-3" alt="Accommodation Image">
                                            <div id="acc-detail-video" class="video-responsive">
                                ...
                                <h3 class="section-heading">4. Select Vehicle (Optional)</h3>
                                <div class="row g-3 mb-4">
                                    <div class="col-12">
                                        <div class="selection-card d-flex align-items-center" data-service-type="vehicle" data-value="none">
                                    ...
                                    <div class="col-md-6">
                                        <div class="selection-card d-flex align-items-center" data-service-type="vehicle" data-value="car">
                                            ...
                                            <label class="form-check-label w-100" for="vehicleCar">
                                                ...
                                                <small class="text-muted">Capacity: 4 | Avg. Price: $50/day</small>
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="selection-card d-flex align-items-center" data-service-type="vehicle" data-value="van">
                                            ...
                                            <label class="form-check-label w-100" for="vehicleVan">
                                                ...
                                                <small class="text-muted">Capacity: 8 | Avg. Price: $80/day</small>
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="selection-card d-flex align-items-center" data-service-type="vehicle" data-value="tuk-tuk">
                                            ...
                                            <label class="form-check-label w-100" for="vehicleTukTuk">
                                                ...
                                                <small class="text-muted">Capacity: 3 | Avg. Price: $20/day</small>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <h3 class="section-heading">5. Additional Notes & Confirmation</h3>
                                <div class="row g-3">
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <textarea class="form-control" placeholder="Special Requests or Notes" id="specialRequests" style="height: 120px"></textarea>
                            ...
                            <div id="bookingConfirmation" class="alert-success-custom text-center">
                                Your customized booking has been submitted! We'll contact you shortly.
                                <br><a href="index.php" class="alert-link text-primary">Go to Homepage</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                document.querySelectorAll('.selection-card').forEach(card => {
                    card.addEventListener('click', function() {
                        ...
                        if (radio) {
                            ...
                            // Handle accommodation details display
                            if (this.dataset.serviceType === 'accommodation') {
                ...
                bookingForm.addEventListener('submit', function(event) {
                    ...
                    console.log('Destination:', document.getElementById('destinationSelect').value);
                    console.log('Start Date:', document.getElementById('st  artDate').value);
                    console.log('End Date:', document.getElementById('endDate').value);
                    console.log('Selected Guide:', document.querySelector('input[name="tourGuide"]:checked').value);
                    console.log('Selected Accommodation:', document.querySelector('input[name="accommodation"]:checked').value);
                    console.log('Selected Vehicle:', document.querySelector('input[name="vehicle"]:checked').value);
                    console.log('Special Requests:', document.getElementById('specialRequests').value);
